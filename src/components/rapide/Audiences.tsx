      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-6 lg:grid-cols-2">
          {cards.map((c, i) => {
            ...
            const cardClass =
              "group relative flex flex-col overflow-hidden rounded-3xl glass p-8 transition hover:border-primary/40 md:p-10 h-full w-full text-left";
            ...
            return (
              ...
              >
                {c.onClick ? (
                  <button onClick={c.onClick} className={cardClass}>
                  ...
                  <Link to={c.to!} className={cardClass}>
                    <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-primary/20 blur-3xl opacity-0 transition duration-500 group-hover:opacity-100" />
                    {inner}
                  </Link>
                )}
