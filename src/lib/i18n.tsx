...
const dict: Dict = {
  ...
  "book.target_pickup": { fr: "Collecte", en: "Pickup" },
  "book.target_dropoff": { fr: "Livraison", en: "Dropoff" },
  "book.continue": { fr: "Continuer", en: "Continue" },
  "book.step2.desc": { fr: "À qui l'envoyons-nous ?", en: "Who are we sending it to?" },
  "book.recipient_desc": { fr: "Requis pour la livraison", en: "Required for delivery" },
  "book.full_name": { fr: "Nom complet", en: "Full name" },
  "book.phone_number": { fr: "Numéro de téléphone", en: "Phone number" },
  "book.sender": { fr: "Expéditeur", en: "Sender" },
  "book.optional": { fr: "Optionnel", en: "Optional" },
  "book.your_name": { fr: "Votre nom", en: "Your name" },
  "book.your_phone": { fr: "Votre téléphone", en: "Your phone" },
  "book.what_inside": { fr: "Que contient le colis ?", en: "What's inside the parcel?" },
  "book.special_instructions": { fr: "Instructions spéciales", en: "Special instructions" },
  "book.get_quote": { fr: "Voir le devis", en: "Get quote" },
  "book.step3.desc": { fr: "Finalisez votre course", en: "Finalize your trip" },
  "book.insurance_desc": { fr: "Couverture jusqu'à 50,000 FCFA", en: "Coverage up to 50,000 FCFA" },
  "book.receipt": { fr: "Reçu de Livraison", en: "Delivery Receipt" },
  "book.departure": { fr: "Départ", en: "Departure" },
  ...
  "auto.motorbike": { fr: "Moto", en: "Motorbike" },
